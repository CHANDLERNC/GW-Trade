...
export const NAME_COLORS: NameColor[] = [
  ...
  { id: 'sand',    hex: '#C8B89A', label: 'Sand',     unlockHint: 'Available to all',    isLocked: () => false },
  { id: 'sage',    hex: '#7DAA8A', label: 'Sage',     unlockHint: 'Available to all',    isLocked: () => false },
  { id: 'slate',   hex: '#7A8FA6', label: 'Slate',    unlockHint: 'Available to all',    isLocked: () => false },
