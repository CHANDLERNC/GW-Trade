...
| Version | Change |
|---------|--------|
| 1.4.1 | Emergency patch: LFG posts broken (undefined constant crash), 8 stuck spinner fixes, edit listing wantInReturn validation, user message delete (long press), in-game USD currency text |
